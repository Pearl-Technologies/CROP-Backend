    ...
    if (user) {
      ...
      const mailData = {
        ...
        <p>Verify your email address to complete the signup and login into your <strong>CROP</strong> account.</p>
          ...
          <a href="${process.env.STORE_URL}/email-verify/${token}" style="background:#22c55e;color:white;border:1px solid #22c55e; padding: 10px 15px; border-radius: 4px; text-decoration:none; cursor:"pointer">Verify Account</a>
  ...
  try {
    ...
    if (!user) {
      ...
      const body = {
        ...
        <p>A request has been received to change the password for your <strong>Crop</strong> account </p>
